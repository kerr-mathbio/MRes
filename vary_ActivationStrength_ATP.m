%declaring a function named vary_ActivationStrength_ATP that accepts inputs X,ActivationStrength,ATP
% and returns outputs in F
function F = vary_ActivationStrength_ATP(X,ActivationStrength,ATP)
