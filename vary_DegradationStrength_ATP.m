%declaring a function named vary_DegradationStrength_ATP that accepts inputs X,DegradationStrength,ATP
% and returns outputs in F
function F = vary_DegradationStrength_ATP(X,DegradationStrength,ATP)
