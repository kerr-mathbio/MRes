%declaring a function named vary_InhibitionStrength_ATP that accepts inputs X,InhibitionStrength,ATP
% and returns outputs in F
function F = vary_InhibitionStrength_ATP(X,InhibitionStrength,ATP)
